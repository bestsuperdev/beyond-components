...
var Notification = (function (_super) {
    ...
    Notification.prototype.render = function () {
        ...
        var child = this.state.visible ? (React.createElement(Content_1["default"], { extraClassName: extraClassName, reverse: reverse }, message || children)) : null;
        return (React.createElement(Container_1["default"], { x: x, y: y },
            React.createElement(ReactCSSTransitionGroup, { transitionName: consts_1.prefix + "notification-animation", transitionEnterTimeout: 300, transitionLeaveTimeout: 300 }, child)));
    };
    return Notification;
}(React.Component));

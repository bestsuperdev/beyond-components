...
var Option = (function (_super) {
    ...
    Option.prototype.render = function () {
        ...
        if (matchValue) {
            ...
            return (React.createElement("div", { className: classnames(nprefix + "-option", indent && 'text-ind20'), onClick: this.props.onClick, key: this.props.key && this.props.key }, (matchValue && (React.createElement("div", null,
                strObj.strBegin,
                React.createElement("b", null, matchValue),
                strObj.strEnd))) || text));
        }
        else {
            return (React.createElement("div", { className: classnames(nprefix + "-option", indent && 'text-ind20'), onClick: this.props.onClick, key: this.props.key && this.props.key }, text));
        }
    };
    return Option;
}(React.Component));
...
var SearchSelector = (function (_super) {
    ...
    SearchSelector.prototype.renderInput = function () {
        ...
        if (withoutText || (!withoutText && showOption)) {
            return (React.createElement("div", { className: classnames(nprefix + "-input", !withoutText && 'mlr-10 bd', withoutText && 'plr-10') },
    ...
    SearchSelector.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: 'wrap', className: classnames("" + nprefix, (!withoutText) && ((this.state.showOption && nprefix + "-arrowUp") || (!this.state.showOption && nprefix + "-arrowDown")), extraClassName) },
            !withoutText &&
            ...
            React.createElement("div", { className: classnames(nprefix + "-container", withoutText && 'container-relative') },
                this.renderInput(),
                this.renderOptions())));
    };

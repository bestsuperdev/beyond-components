...
var modalBodyOpenClassName = 'modal-body-open';
...
var Modal = (function (_super) {
    ...
    Modal.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, visible = _a.visible, extraClassName = _a.extraClassName, maskClickClose = _a.maskClickClose, width = _a.width, maxWidth = _a.maxWidth, bodyHeight = _a.bodyHeight, maxBodyHeight = _a.maxBodyHeight;
        style = assign({}, style);
        if (!visible) {
            style.display = 'none';
        }
    ...
    Modal.prototype.renderHeader = function () {
        var title, closeBtn;
        var _a = this.props, _title = _a.title, close = _a.close, className = _a.className, closeIcon = _a.closeIcon;
    ...
    Modal.prototype.renderFooter = function () {
        if (this.props.footer != null) {
            return (React.createElement("div", { className: classPrefix + "-footer" }, this.props.footer));
        }
    };
    return Modal;
}(React.Component));

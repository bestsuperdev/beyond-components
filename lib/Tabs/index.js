...
var Tabs = (function (_super) {
    ...
    Tabs.prototype.render = function () {
        var _a = this.props, className = _a.className, extraClassName = _a.extraClassName, style = _a.style;
    ...
    Tabs.prototype.renderNavs = function () {
        ...
        var navs = children.filter(function (child) { return child != null; }).map(function (child) {
            ...
            var events = {};
            if (!disabled) {
                events.onClick = _this.handlerClick.bind(_this, key);
            }
...
Tabs.defaultProps = {
    className: consts_1.prefix + "tabs"
};
